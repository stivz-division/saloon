        ...
        <div class="container-fluid">
            ...
            >
                ...
                <div class="social">
                    <div>
                        {{--                        Написать:--}}
                        <a href="mailto:7921920@gmail.com" target="_blank">
                            <img src="{{ Vite::asset('resources/images/email_logo.png') }}" alt="Email"
                                 style="width: 32px; height: 32px;">
                        </a>
                        <a href="https://wa.me/79219201792" target="_blank">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" alt="WhatsApp"
                                 style="width: 40px; height: 40px;">
                        </a>
                        <a href="https://t.me/Gerffin" target="_blank">
                            <img src="https://telegram.org/img/t_logo.png" alt="Telegram"
                                 style="width: 32px; height: 32px;">
                        </a>
                    </div>
                    <div class="space" style="width: 150px;"></div>
                </div>
                <div>
                    <a
